...
struct MemoryGame<CardContent> where CardContent: Equatable {
    ...
    struct Card: Identifiable {
        ...
        // this could give matching bounus poionts
        // if the user matches the card
        // before a certain amount of tome passes during which the card is face up
        ...
        // called when the card transitions to dace up state
